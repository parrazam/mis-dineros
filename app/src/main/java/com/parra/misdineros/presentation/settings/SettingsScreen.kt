    ...
    Scaffold(
        ...
        Column(
            ...
            NavSettingsItem(
                ...
                onClick = {
                    scope.launch { snackbarHostState.showSnackbar("Exportación disponible en la Fase 9") }
                },
            )
            NavSettingsItem(
                ...
                onClick = {
                    scope.launch { snackbarHostState.showSnackbar("Importación disponible en la Fase 9") }
                },
            )
            HorizontalDivider()
